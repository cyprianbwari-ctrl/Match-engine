...
function CurrentInjuries() { return <section className="staff-panel injuries"><div className="panel-title"><h2>Current Injuries & Expected Return</h2></div>{[['Nahuel Ibarra', 'Knee Ligament Tear', '12 Jan 2026', 'red'], ['Charlie Pemberton', 'Hamstring Injury', '5 Jan 2026', 'red'], ['Jamie Colton', 'Calf Strain', '20 Dec 2025', 'gold'], ['Anders Krogh', 'Ankle Sprain', '8 Jan 2026', 'gold']].map(x => <div key={x[0]}><Pill color={x[3]}>{x[0]}</Pill><span>{x[1]}</span><b>{x[2]}</b></div>)}</section>; }
