...
export const players = [
  {id:1,pos:"GK",name:"Étienne Mbarga",role:"SK",nat:"🇨🇲",fit:96,rate:6.8,
  ...
  {id:2,pos:"DR",name:"Rui Cabral",role:"WB",nat:"🇵🇹",fit:94,rate:7.0,
  ...
  {id:3,pos:"DC",name:"Callum Whitfield",role:"CD",nat:"🏴",fit:78,rate:7.1,
  ...
  {id:4,pos:"DC",name:"Nahuel Ibarra",role:"CD",nat:"🇦🇷",fit:92,rate:7.3,
  ...
  {id:5,pos:"DL",name:"Jamie Colton",role:"FB",nat:"🏴",fit:80,rate:7.0,
  ...
  {id:6,pos:"DM",name:"Wagner Aguiar",role:"DM",nat:"🇧🇷",fit:90,rate:7.3,
  ...
  {id:7,pos:"MC",name:"Tyrell Osei",role:"DLP",nat:"🏴",fit:92,rate:7.1,
  ...
  {id:8,pos:"AMC",name:"Rafael Teixeira",role:"AP",nat:"🇵🇹",fit:96,rate:7.8,
  ...
  {id:9,pos:"AML",name:"Jayden Okafor",role:"IF",nat:"🏴",fit:85,rate:7.6,
  ...
  {id:10,pos:"AMR",name:"Mateo Villanueva",role:"IW",nat:"🇦🇷",fit:93,rate:7.2,
  ...
  {id:11,pos:"ST",name:"Anders Krogh",role:"AF",nat:"🇩🇰",fit:88,rate:7.4,
  ...
  // bench / squad depth
  {id:12,pos:"GK",name:"Emre Sancak",role:"GK",nat:"🇹🇷",fit:85,rate:6.5,
  ...
  {id:13,pos:"DC",name:"Oskar Berggren",role:"CD",nat:"🇸🇪",fit:90,rate:6.9,
  ...
  {id:14,pos:"DM",name:"Facundo Rivas",role:"DM",nat:"🇺🇾",fit:93,rate:6.9,
  ...
  {id:15,pos:"ST",name:"Bram Dekker",role:"F9",nat:"🇳🇱",fit:89,rate:7.0,
  ...
  {id:16,pos:"DC",name:"Théo Marchand",role:"CD",nat:"🇫🇷",fit:91,rate:7.0,
  ...
  {id:17,pos:"DC",name:"Sven Kuiper",role:"BPD",nat:"🇳🇱",fit:90,rate:7.2,
  ...
  {id:18,pos:"DR",name:"Marcus Adeyemi",role:"FB",nat:"🏴",fit:82,rate:6.9,
  ...
  {id:19,pos:"MC",name:"Yassine Belkacem",role:"BWM",nat:"🇲🇦",fit:81,rate:6.8,
  ...
  {id:20,pos:"MC",name:"Mikkel Sørensen",role:"DLP",nat:"🇩🇰",fit:75,rate:6.9,
  ...
  {id:21,pos:"GK",name:"Dean Hargreaves",role:"GK",nat:"🏴",fit:70,rate:6.3,
  ...
  {id:22,pos:"AMR",name:"Ibrahim Koné",role:"IW",nat:"🇨🇮",fit:90,rate:7.3,
  ...
  {id:23,pos:"AMR",name:"Gustavo Lemos",role:"W",nat:"🇧🇷",fit:83,rate:6.7,
  ...
  {id:24,pos:"MC",name:"Charlie Pemberton",role:"CM",nat:"🏴",fit:79,rate:6.6,
  ...
  {id:25,pos:"AMR",name:"Bruno Etchegoyen",role:"W",nat:"🇺🇾",fit:88,rate:6.7,
  ...
  {id:26,pos:"MC",name:"Ollie Bramwell",role:"CM",nat:"🏴",fit:92,rate:6.4,
  ...
  {id:27,pos:"ST",name:"Kai Osborne",role:"AF",nat:"🏴",fit:90,rate:6.3,
  ...
  {id:28,pos:"DM",name:"Ryan Fenwick",role:"DM",nat:"🏴",fit:89,rate:6.3,
  ...
  {id:29,pos:"MC",name:"Sam Whitlock",role:"CM",nat:"🏴",fit:90,rate:6.0,
  ...
  {id:30,pos:"GK",name:"Tomáš Novák",role:"GK",nat:"🇨🇿",fit:90,rate:6.0,
