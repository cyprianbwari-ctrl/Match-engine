...
const raw = [
  ...
  [19, 'Matteo Brunner', '🇩🇪', 'CAM', 'Leverkusen', 21, 81, [78, 80, 82, 83, 85], '€50M', 3],
  ...
  [23, 'Viktor Solheim', '🇸🇪', 'ST', 'Napoli', 25, 78, [76, 77, 79, 80, 78], '€85M', 1],
...
export const leagues = [
  { league: 'Premier League', country: 'England', strength: 96, knowledge: 88, topClubs: ['Man City', 'Arsenal', 'Liverpool', 'Newcastle'] },
...
export const wonderkids = [
  ...
  { name: 'Matteo Brunner', age: 21, pos: 'CAM', club: 'Leverkusen', potential: 94 },
...
export const transferActivity = [
  ...
  { headline: 'Liverpool open talks over Viktor Solheim', detail: 'Discussions are at an early stage over a potential summer move.', time: '1 day ago', tag: 'Rumour' },
];
